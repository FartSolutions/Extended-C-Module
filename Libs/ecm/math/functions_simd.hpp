...
namespace ecm::math
{
	 ...
	 * \since v1.0.0
	 */
	ECM_NODISCARD constexpr __m128 ECM_CALL Fma(__m128 a, __m128 b, __m128 c);
	 ...
	 * \since v1.0.0
	 */
	ECM_NODISCARD constexpr __m128 ECM_CALL SplatX(__m128 v);
	 ...
	 * \since v1.0.0
	 */
	ECM_NODISCARD constexpr __m128 ECM_CALL SplatY(__m128 v);
	 ...
	 * \since v1.0.0
	 */
	ECM_NODISCARD constexpr __m128 ECM_CALL SplatZ(__m128 v);
	 ...
	 * \since v1.0.0
	 */
	ECM_NODISCARD constexpr __m128 ECM_CALL SplatW(__m128 v);
} // namespace ecm::math
