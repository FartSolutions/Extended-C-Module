...
xcopy libs\ecm.window\ecm\*.h;*.hpp RELEASE\include\ecm\ /y /v /s
:: Pack released library
"C:\Program Files\7-Zip\7z.exe" a -r -mx9 .\RELEASE\ecm_win32_x64_full.7z .\RELEASE\x64\
"C:\Program Files\7-Zip\7z.exe" a -r -mx9 .\RELEASE\ecm_win32_x64_binaries.7z .\RELEASE\x64\
"C:\Program Files\7-Zip\7z.exe" a -r -mx9 .\RELEASE\ecm_win32_x86_full.7z .\RELEASE\x86\
"C:\Program Files\7-Zip\7z.exe" a -r -mx9 .\RELEASE\ecm_win32_x86_binaries.7z .\RELEASE\x86\
